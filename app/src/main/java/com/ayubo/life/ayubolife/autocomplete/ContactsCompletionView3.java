 ...
 * @author mgod
 */
public class ContactsCompletionView3 extends TokenCompleteTextView<DBString> {
    ArrayList<DBString> locationList = new ArrayList<DBString>();
    ;

    public ContactsCompletionView3(Context context) {
        super(context);
    }

    public ContactsCompletionView3(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ContactsCompletionView3(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected View getViewForObject(DBString person) {
        ...
        System.out.println("-----------------Locations---------------...>>>" + person.getName());
        token.setText(person.getName());
        // token.setText("");
        locationList.add(person);
        //  Ram.setLocationList(locationList);
