...
public class ReportsCommonViewForReload extends AppCompatActivity {
    private static final String TAG = com.ayubo.life.ayubolife.activity.CommonWebViewActivity.class.getSimpleName();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (Integer.parseInt(android.os.Build.VERSION.SDK) > 5 && keyCode == KeyEvent.KEYCODE_BACK
            ...
            Intent in = new Intent(ReportsCommonViewForReload.this, SelectFamilyMember_Activity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reports_common_view_for_reload);
        ...
        try {
            if (web_url.contains("activity_tracker")) {
                ...
                if (Build.VERSION.SDK_INT >= 23 && (ContextCompat.checkSelfPermission(ReportsCommonViewForReload.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)) {
                    ActivityCompat.requestPermissions(ReportsCommonViewForReload.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        ...
        v = (Vibrator) ReportsCommonViewForReload.this.getSystemService(Context.VIBRATOR_SERVICE);
...
//        }
        try {
            ...
            if (Utility.isInternetAvailable(ReportsCommonViewForReload.this)) {

                web_prgDialog = new ProgressDialog(ReportsCommonViewForReload.this);
                ...
                webView.addJavascriptInterface(new ReportsCommonViewForReload.WebAppInterface(this), "Android");
                webView.setWebViewClient(new ReportsCommonViewForReload.Callback());
                ...
                System.out.println("=====================url in..Common Webview ..................." + web_url);
                ...
                webView.setWebChromeClient(new WebChromeClient() {
                    ...
                    public boolean onShowFileChooser(
                        ...
                        if (Build.VERSION.SDK_INT >= 23 && (ContextCompat.checkSelfPermission(ReportsCommonViewForReload.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) + ContextCompat
                                .checkSelfPermission(ReportsCommonViewForReload.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
                        ...
                        if (takePictureIntent.resolveActivity(ReportsCommonViewForReload.this.getPackageManager()) != null) {
                            File photoFile = null;
                            try {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.contains(MAIN_URL_APPS)) {
                if (url.contains("openInView=true")) {
                    val = true;
                    Intent intent = new Intent(ReportsCommonViewForReload.this, com.ayubo.life.ayubolife.activity.CommonWebViewActivity.class);
                ...
                if (url.contains("openInBrowser=true")) {
                    ...
                    val = true;
                    Intent intent = new Intent(ReportsCommonViewForReload.this, MyHealthDataActivity.class);
                    startActivity(intent);
                    return val;
...
//                    Intent intent = new Intent(getBaseContext(), NewDiscoverActivity.class);
                    ...
                    val = true;
                    Intent in = new Intent(ReportsCommonViewForReload.this, WaterActivity.class);
                    startActivity(in);
                    return val;
                } else {
                    val = true;
...
//                    Intent intent = new Intent(getBaseContext(), NewDiscoverActivity.class);
            ...
            if (url.contains("subscriptionView")) {
                val = true;
                Intent in = new Intent(ReportsCommonViewForReload.this, Medicine_ViewActivity.class);
                startActivity(in);
                return val;
            } else if (url.contains("medicineView")) {
                val = true;
                Intent in = new Intent(ReportsCommonViewForReload.this, RXViewActivity.class);
                startActivity(in);
                return val;
            } else if (url.contains("scheduleExpertView")) {
                val = true;
                Intent in = new Intent(ReportsCommonViewForReload.this, ExpertViewActivity.class);
                startActivity(in);
                return val;
            } else if (url.contains("vibrate")) {
                ...
                val = true;
                Intent intent = new Intent(getBaseContext(), com.ayubo.life.ayubolife.activity.CommonWebViewActivity.class);
                intent.putExtra("URL", url);
                startActivity(intent);
                return val;
            }
    ...
    public class WebAppInterface {
        ...
        public void moveToNextScreen(String s) {
            ...
            Intent chnIntent = new Intent(ReportsCommonViewForReload.this, com.ayubo.life.ayubolife.activity.CommonWebViewActivity.class);
