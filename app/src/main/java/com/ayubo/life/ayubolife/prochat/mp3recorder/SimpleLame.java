package com.ayubo.life.ayubolife.prochat.mp3recorder;
...
public class SimpleLame {
    ...
    public static int encode(short[] buffer_l, short[] buffer_r, int samples, byte[] mp3buf) {
        return androidLame.encode(buffer_l, buffer_r, samples, mp3buf);
    }
    ...
    public static int flush(byte[] mp3buf) {
        return androidLame.flush(mp3buf);
    }
