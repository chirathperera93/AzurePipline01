...
import com.ayubo.life.ayubolife.health.Health_ReportsFragment;
 ...
 * {@link Body_HistoryFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Body_HistoryFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Body_HistoryFragment extends Fragment {
    ...
    DatabaseHandler db;private PrefManager pref;
     ...
     * @return A new instance of fragment Body_HistoryFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Body_HistoryFragment newInstance(String param1, String param2) {
        Body_HistoryFragment fragment = new Body_HistoryFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  return inflater.inflate(R.layout.fragment_body__history, container, false);

        View view = inflater.inflate(R.layout.fragment_body__history, container, false);
        ...
        url = ApiClient.BASE_URL+"index.php?module=Documents&action=dynamicHistoryView&filter=workout&hash=";
...
//            webProgress_timeline.setMessage("Loading...");
            ...
            webView = (WebView) view.findViewById(R.id.webView_body_medicalreports);
