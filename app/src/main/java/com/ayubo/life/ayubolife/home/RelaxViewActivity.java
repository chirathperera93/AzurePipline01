...
public class RelaxViewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toastt = new Toast(RelaxViewActivity.this);
     ...
     //   pd.getWindow().clearFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
        ...
        pref=new PrefManager(RelaxViewActivity.this);
        ...
        DBString dataObj= DBRequest.getCashDataByType(RelaxViewActivity.this,"relax_data");
        ...
        if(pref.getRefreshDataType().equals("relax")){
            ...
            if (Utility.isInternetAvailable(this)) {
                if((dat!=null) && (dat.length()>10)){
                    ...
                    MyProgressLoading.showLoading(RelaxViewActivity.this,"Please wait...");
                }
    ...
    //    expListView.setDividerHeight(-10);
        ...
        if(tracksmyListsAll!=null){
            tCount= tracksmyListsAll.length();
        }
        if(videosmyListsAll!=null){
            vCount= videosmyListsAll.length();
        }
        if(programsListsAll!=null){
        ...
        if(pCount!=0){
            ...
            listDataHeader.add(new DBString("Time to","Nourish"));//for programs
        ...
        listAdapter = new ExpandableListAdapter(RelaxViewActivity.this, listDataHeader, listDataChild);
        ...
        expListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            //    ImageListObj webLIggnk= listDataChild.get(listDataHeader.get(groupPosition));
                ...
                if(SplashScreen.firebaseAnalytics!=null) {
                    SplashScreen.firebaseAnalytics.logEvent("Relax_program_clicked", bPromocode_used);
                }
    ...
    private void makePostRequest_updateOnlineWorkoutDetails() {
        ...
        List<NameValuePair> nameValuePair = new ArrayList<NameValuePair>();
            ...
            nameValuePair.add(new BasicNameValuePair("method", "getCategoryRelaxList"));
            ...
            if (response != null) {
                ...
                if(r==200){
                    try {
                        ...
                        System.out.println("..........Relax............." + responseString);
                        ...
                        if (statusFromServiceAPI_db.equals("0")) {
                            ...
                            DBRequest.updateDoctorData(RelaxViewActivity.this,main_service_data,"relax_data");

                            pref.setAllRelaxData("a");
                        }
                    } catch (Exception e) {
    ...
    public class ExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, final int childPosition,
          ...
          //  ProgressBar progressNewsList = (ProgressBar) convertView.findViewById(R.id.progressNewsList);
            ...
            progressBar=new ProgressBar(RelaxViewActivity.this);
            RequestOptions myOptions = new RequestOptions()
                    .fitCenter()
                    .diskCacheStrategy(DiskCacheStrategy.ALL);
            Glide.with(RelaxViewActivity.this).load(imageLine)
                    .apply(myOptions)
