...
import kotlinx.android.synthetic.main.fragment_last_week_my_step.view.*
 ...
 * Use the [LastWeekMyStepFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class LastWeekMyStepFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        mainView = inflater.inflate(R.layout.fragment_last_week_my_step, container, false)
    ...
    private fun loadData() {
        mainView.myLastWeekStepSummaryLoading.visibility = View.VISIBLE
        ...
        call.enqueue(object : Callback<V1GetStepSummaryResponse> {
            override fun onResponse(
                ...
                mainView.myLastWeekStepSummaryLoading.visibility = View.GONE
    ...
    private fun setBarChartData(mainResponse: V1GetStepSummaryData) {
        ...
        mainView.barLastWeekChart.description.isEnabled = false

        // if more than 60 entries are displayed in the chart, no values will be
        // drawn
        mainView.barLastWeekChart.setMaxVisibleValueCount(40)

        // scaling can now only be done on x- and y-axis separately
        mainView.barLastWeekChart.setPinchZoom(false)

        mainView.barLastWeekChart.setDrawGridBackground(false)
        mainView.barLastWeekChart.setDrawBarShadow(false)

        mainView.barLastWeekChart.setDrawValueAboveBar(false)
        mainView.barLastWeekChart.isHighlightFullBarEnabled = false

        // change the position of the y-labels
        val leftAxis: YAxis = mainView.barLastWeekChart.axisLeft

        leftAxis.axisMinimum = 0f // this replaces setStartAtZero(true)
        mainView.barLastWeekChart.axisRight.isEnabled = false

        val xLabels: XAxis = mainView.barLastWeekChart.xAxis
...
//        set1.stackLabels = arrayOf("Achieved", "Target")
        ...
        mainView.barLastWeekChart.data = data
        mainView.barLastWeekChart.setFitBars(true)
        mainView.barLastWeekChart.invalidate()


        val l: Legend = mainView.barLastWeekChart.legend
        l.isEnabled = false

        // add a nice and smooth animation
        mainView.barLastWeekChart.animateY(1500)
...
//         chart.setDrawLegend(false);
    ...
    companion object {
         ...
         * @return A new instance of fragment LastWeekMyStepFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            LastWeekMyStepFragment().apply {
