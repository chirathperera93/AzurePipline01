package com.ayubo.life.ayubolife.channeling.config;
...
public class AppConfig {
   ...
   // public static final String HEMAS_USER_ID = "be0a5cbb-a2d5-2061-c4af-595e0345ebed";
    ...
    public static final String AYUBO_BASIC_URL = ApiClient.BASE_URL;
...
//    public static final String URL_AYUBO_SOAP_REQUEST = AYUBO_BASIC_URL + "custom/service/v4_1_custom/rest.php";
    public static final String URL_AYUBO_SOAP_REQUEST = AYUBO_BASIC_URL + "custom/service/v7/rest.php";
    public static final String URL_PHOTO_UPLOAD = AYUBO_BASIC_URL + "index.php?entryPoint=video_call_file_upload";
    ...
    public static final String METHOD_SOAP_DAILOG_PAY_CHANELLING = "chanellingDialogAddtoBill";
    public static final String METHOD_SOAP_DAILOG_PAY_VIDEO = "videoCallDialogAddToBill";
    ...
    public static final String METHOD_SOAP_GET_VIDEO_SESSIONS = "videoCallSessions";
    public static final String METHOD_SOAP_VIDEO_TIME_SLOTS = "videoCallTimeSlots";

    public static final String OFFLINE_FILE_FAVOURITE = "offline_favourite";
    public static final String OFFLINE_FILE_DOCTORS = "offline_doctors";
    public static final String OFFLINE_FILE_SPECIALITY = "offline_speciality";
    public static final String OFFLINE_FILE_LOCATION = "offline_location";
    public static final String OFFLINE_FILE_SELECT_DOCTOR = "offline_select_doctor";
