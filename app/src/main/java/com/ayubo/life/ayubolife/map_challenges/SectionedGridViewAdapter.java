...
public class SectionedGridViewAdapter extends BaseAdapter implements
	...
	HashMap<String, List<Achievement>> listDataChild=null;
	...
	public SectionedGridViewAdapter(Context context,
                                    ...
                                    int listViewHeight, int gridItemSquareSize,HashMap<String, List<Achievement>> listDataChild) {
		this.con=context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			if (isSectionheader) {
				...
				LinearLayout ll = (LinearLayout) inflater.inflate(
						R.layout.list_raw_gridview, null);
				v = ll;
		...
		if (isSectionheader) {
			...
			for (int i = 0; i < 2 * numberOfChildrenInRow - 1; i++) {
				...
				List<Achievement> listDataild=listDataChild.get(sectionName);
				Achievement ob=listDataild.get(positionInSection);
				String sss=ob.getName();
				String path=ob.getImage();
