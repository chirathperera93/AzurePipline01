...
public class DayActivitiesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_backImgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent chnIntent = new Intent(DayActivitiesActivity.this, NewHomeWithSideMenuActivity.class);
        ...
        try {
            if (url.contains("mobile_health_tracker")) {
                ...
                if (Build.VERSION.SDK_INT >= 23 && (ContextCompat.checkSelfPermission(DayActivitiesActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED )) {
                    ActivityCompat.requestPermissions(DayActivitiesActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        ...
        v = (Vibrator) DayActivitiesActivity.this.getSystemService(Context.VIBRATOR_SERVICE);
        ...
        try{
            ...
            if (Utility.isInternetAvailable(DayActivitiesActivity.this)) {

                web_prgDialog = new ProgressDialog(DayActivitiesActivity.this);
                ...
                System.out.println("url in......Common Webview ..................."+url+encodedHashToken);
                webView.loadUrl(url);
                webView.setWebChromeClient(new WebChromeClient(){
                    ...
                    public boolean onShowFileChooser(
                        ...
                        if (Build.VERSION.SDK_INT >= 23 && (ContextCompat.checkSelfPermission(DayActivitiesActivity.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) + ContextCompat
                                .checkSelfPermission(DayActivitiesActivity.this,Manifest.permission.CAMERA)!= PackageManager.PERMISSION_GRANTED)) {
                        ...
                        if(takePictureIntent.resolveActivity(DayActivitiesActivity.this.getPackageManager()) != null){
                            File photoFile = null;
                            try{
    ...
    public class Callback extends WebViewClient{
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if(url.contains(MAIN_URL_LIVE_HAPPY + "subscriptionView")){
                val=true;
                Intent in = new Intent(DayActivitiesActivity.this, Medicine_ViewActivity.class);
                startActivity(in);
                return val;
            }
            else if(url.contains(MAIN_URL_LIVE_HAPPY + "medicineView")){
                val=true;
                Intent in = new Intent(DayActivitiesActivity.this, RXViewActivity.class);
                startActivity(in);
                return val;
            }
            else if(url.contains(MAIN_URL_LIVE_HAPPY + "scheduleExpertView")){
                val=true;
                Intent in = new Intent(DayActivitiesActivity.this, ExpertViewActivity.class);
                startActivity(in);
                return val;
            }
                ...
                val=true;
                Intent in = new Intent(DayActivitiesActivity.this, WaterActivity.class);
                startActivity(in);
                return val;
            }
    ...
    public class WebAppInterface {
        ...
        public void moveToNextScreen(String s){
            ...
            Intent chnIntent = new Intent(DayActivitiesActivity.this, DayActivitiesActivity.class);
