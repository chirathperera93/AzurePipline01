...
import com.ayubo.life.ayubolife.top_menu.Home;
...
public class ConnectFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_connect,
                container, false);
        ...
        {  try {
            ...
            url = ApiClient.BASE_URL_entypoint + "=ayuboLifeTimelineLogin&type=connectDevices&ref=";
            ...
            if (Utility.isInternetAvailable(getContext())) {
                ...
                webView = (WebView) view.findViewById(R.id.webView_connect);
