...
class SelectanExpertActivityVM @Inject constructor(val apiService: ApiService,
                                                   val sharedPref: SharedPreferences){

    var serverRef: String? =null

    fun getExpertData(restString:String) = apiService.getExpertData("https://livehappy.ayubo.life/custom/service/v5/",sharedPref.getAuthToken(), AppConfig.APP_BRANDING_ID,"getChatExperts","JSON","JSON",restString).map {
