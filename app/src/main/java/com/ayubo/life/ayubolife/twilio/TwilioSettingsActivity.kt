...
class TwilioSettingsActivity : AppCompatActivity() {
//    companion object {
...
//            return when (item.itemId) {
//                android.R.id.home -> {
//                    startActivity(Intent(activity, TwilioSettingsActivity::class.java))
//                    true
//                }
//                else -> super.onOptionsItemSelected(item)
//            }
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            setupCodecListPreference(
                ...
                PREF_AUDIO_CODEC,
                PREF_AUDIO_CODEC_DEFAULT,
                findPreference<Preference>(PREF_AUDIO_CODEC)!! as ListPreference
            )
            setupCodecListPreference(
                VideoCodec::class.java,
                PREF_VIDEO_CODEC,
                PREF_VIDEO_CODEC_DEFAULT,
                findPreference<Preference>(PREF_VIDEO_CODEC)!! as ListPreference
            )
            setupSenderBandwidthPreferences(
                PREF_SENDER_MAX_AUDIO_BITRATE,
                PREF_SENDER_MAX_AUDIO_BITRATE_DEFAULT,
                findPreference<Preference>(PREF_SENDER_MAX_AUDIO_BITRATE)!! as EditTextPreference
            )
            setupSenderBandwidthPreferences(
                PREF_SENDER_MAX_VIDEO_BITRATE,
                PREF_SENDER_MAX_VIDEO_BITRATE_DEFAULT,
                findPreference<Preference>(PREF_SENDER_MAX_VIDEO_BITRATE)!! as EditTextPreference
            )
        }
        ...
        private fun setupCodecListPreference(
            ...
            // Remove H264 if not supported
//            if (!VideoDecoder.isH264HwSupported() ||
//                    !MediaCodecVideoEncoder.isH264HwSupported()) {
//                codecEntries.remove(H264Codec.NAME)
//            }
