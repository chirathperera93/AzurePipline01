...
public class AudioPlayerActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        webView.loadUrl("javascript: (function(){ document.getElementById('player').pause();})();");
        finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_backImgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //  webView.loadUrl("javascript: (function(){alert('Test');})();");
                webView.loadUrl("javascript: (function(){ document.getElementById('player').pause();})();");
        ...
        try {
            if (url.contains("activity_tracker")) {
                ...
                if (Build.VERSION.SDK_INT >= 23 && (ContextCompat.checkSelfPermission(AudioPlayerActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)) {
                    ActivityCompat.requestPermissions(AudioPlayerActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        ...
        v = (Vibrator) AudioPlayerActivity.this.getSystemService(Context.VIBRATOR_SERVICE);
...
//        }
        try {
            ...
            if (Utility.isInternetAvailable(AudioPlayerActivity.this)) {

                web_prgDialog = new ProgressDialog(AudioPlayerActivity.this);
                ...
                webView.addJavascriptInterface(new WebAppInterface(this), "player");
                ...
                System.out.println("url in......Common Webview ..................." + url);
                webView.loadUrl(url);
                webView.setWebChromeClient(new WebChromeClient() {
                    ...
                    public boolean onShowFileChooser(
                        ...
                        if (Build.VERSION.SDK_INT >= 23 && (ContextCompat.checkSelfPermission(AudioPlayerActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) + ContextCompat
                                .checkSelfPermission(AudioPlayerActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
                        ...
                        if (takePictureIntent.resolveActivity(AudioPlayerActivity.this.getPackageManager()) != null) {
                            File photoFile = null;
                            try {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.contains(MAIN_URL_APPS)) {
                ...
                if (url.contains("openInBrowser=true")) {
                    ...
                    val = true;
                    Intent intent = new Intent(AudioPlayerActivity.this, MyHealthDataActivity.class);
                    startActivity(intent);
                    return val;
...
//                    Intent intent = new Intent(getBaseContext(), LifePlusProgramActivity.class);
                    ...
                    val = true;
                    Intent in = new Intent(AudioPlayerActivity.this, WaterActivity.class);
                    startActivity(in);
                    return val;
                } else {
                    val = true;
...
//                    Intent intent = new Intent(getBaseContext(), NewDiscoverActivity.class);
            ...
            if (url.contains("subscriptionView")) {
                val = true;
                Intent in = new Intent(AudioPlayerActivity.this, Medicine_ViewActivity.class);
                startActivity(in);
                return val;
            } else if (url.contains("medicineView")) {
                val = true;
                Intent in = new Intent(AudioPlayerActivity.this, RXViewActivity.class);
                startActivity(in);
                return val;
            } else if (url.contains("scheduleExpertView")) {
                val = true;
                Intent in = new Intent(AudioPlayerActivity.this, ExpertViewActivity.class);
                startActivity(in);
                return val;
            } else if (url.contains("vibrate")) {
    ...
    public class WebAppInterface {
        ...
        public void moveToNextScreen(String s) {
            ...
            Intent chnIntent = new Intent(AudioPlayerActivity.this, CommonWebViewActivity.class);
