...
public class CommonListViewWithSearchActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_common_list_view_with_search);
         familyMemberList= new ArrayList<String>();
        familyMemberList=Ram.getAvailableFmilyMemberList();
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Ram.setFamilyMemberName(mem);
                Intent in = new Intent(CommonListViewWithSearchActivity.this, RXView_SecondActivity.class);
                startActivity(in);
                finish();
            }
        });
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                CommonListViewWithSearchActivity.this.adapter.getFilter().filter(cs);
            }
