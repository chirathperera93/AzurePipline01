...
public class OldPrograms implements Serializable
{
    ...
    @Expose
    private String meta;
    private final static long serialVersionUID = 761175746476754883L;

    public OldPrograms(String name, String image, String link, String title, String expert, String buttonText, String commonImage, String action, String meta) {
        this.name = name;
        this.image = image;
        this.link = link;
        this.title = title;
