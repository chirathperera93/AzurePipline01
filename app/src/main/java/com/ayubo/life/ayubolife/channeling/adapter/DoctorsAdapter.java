    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ImageViewHolder) {
            ...
            if (doctor.getName() == null) {
                ...
                detailViewHolder.txtDoctor.setTextColor(ContextCompat.getColor(activity, R.color.black));
                detailViewHolder.imgDoctor.setImageDrawable(ContextCompat.getDrawable(activity, R.drawable.add_new_button));
                // detailViewHolder.imgDoctor.set(50, 50, 50, 50);
            } else {
                ...
                detailViewHolder.txtDoctor.setText(Utility.upperCaseWords(doctor.getFull_name()));
