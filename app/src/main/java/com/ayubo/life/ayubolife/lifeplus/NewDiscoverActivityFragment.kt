 ...
 */
class NewDiscoverActivityFragment : Fragment() {
    ...
    // Urls of our images.
    var url1: String = "https://www.geeksforgeeks.org/wp-content/uploads/gfg_200X200-1.png";
    var url2: String =
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.activity_new_discover_program, container, false);
...
//        val huaweiServices: HuaweiServices = HuaweiServices(getActivity());
...
//                    val deviceName: String? = pref.getDeviceData().get("stepdevice");
//
//                    if (deviceName != null) {
...
//                if (intent.resolveActivity(Objects.requireNonNull(Objects.requireNonNull(context))!!.packageManager) != null) {
//                    activity!!.startActivityForResult(intent, REQUEST_HEALTH_AUTH);
//
//                }
//            } else {
...
//        mSettingController = HuaweiHiHealth.getSettingController(context!!, signInHuaweiId);
//    }
...
//            activity!!.startActivityForResult(signInIntent, REQUEST_SIGN_IN_LOGIN);
//        }
//
//
//    }
...
//    }
    ...
    fun showAlert_Add(c: Context, dataObj: PopupMainData) {
        ...
        val requestOptionsSamll: RequestOptions = RequestOptions().diskCacheStrategy(
...
//            val intent: Intent = Intent(context, NewDiscoverActivity::class.java);
            val intent: Intent = SetDiscoverPage().getDiscoverIntent(requireContext());
