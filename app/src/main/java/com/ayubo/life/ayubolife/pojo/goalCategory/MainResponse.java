...
public class MainResponse implements Parcelable
{
    ...
    @SerializedName("data")
    @Expose
    private List<com.ayubo.life.ayubolife.pojo.goalCategory.Datum> data = null;
    ...
    protected MainResponse(Parcel in) {
        ...
        in.readList(this.data, (com.ayubo.life.ayubolife.pojo.goalCategory.Datum.class.getClassLoader()));
    }
