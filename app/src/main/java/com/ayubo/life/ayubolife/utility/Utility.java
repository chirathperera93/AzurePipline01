...
import static com.ayubo.life.ayubolife.R.drawable.cal;
...
public class Utility {
    ...
    public static List<Date> getDatesBetweenUsingJava7(Date startDate, Date endDate) {
        ...
        datesInRange.add(new Date(begin.getTime()));
...
//        datesInRange.add(result);
    ...
    public static Bitmap getResizedBitmapImport(float squareBitmapWidth,Bitmap bitmap) {
    ...
    public static void hideSoftKeyboard(PostDataActivity activity) {
        InputMethodManager inputMethodManager =
                (InputMethodManager) activity.getSystemService(
                        PostDataActivity.INPUT_METHOD_SERVICE);
...
//    }
    ...
    public static List<DBString> getLocationList(String location_text) {
    ...
    for (String onelocation: lo.split(",")) {
        String arr[] =onelocation.split("_");
        String id=arr[0];
        String name=arr[1];
        DBString locatObj=new DBString(id,name);
        myLocationsList.add(locatObj);
    }
    ...
    public static Long getTimpstampDifferent( Long valBig, Long valSmall){
          Long deference = null;

        deference=valBig - valSmall;
          return deference;
    }
