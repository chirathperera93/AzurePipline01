package com.ayubo.life.ayubolife.mobile_login;
...
public class HttpService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Log.e(TAG, "onHandleIntent =====================HttpService====================");
        Log.e(TAG, "onHandleIntent =========================================");
        Log.e(TAG, "onHandleIntent =========================================");
        if (intent != null) {
            String otp = intent.getStringExtra("otp");
            Log.e(TAG, "WelcomeHome =========================================");
            Log.e(TAG, "WelcomeHome =========================================");
            Log.e(TAG, "WelcomeHome =========================================");
            Log.e(TAG, "WelcomeHome =========================================");
            Intent intent2 = new Intent(HttpService.this, NewHomeWithSideMenuActivity.class);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Intent intent = new Intent(HttpService.this, NewHomeWithSideMenuActivity.class);
