...
import kotlinx.android.synthetic.main.fragment_last_month_step.view.*
 ...
 * Use the [LastMonthStepFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class LastMonthStepFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        mainView = inflater.inflate(R.layout.fragment_last_month_step, container, false)
    ...
    private fun loadData() {
        mainView.myLastMonthStepSummaryLoading.visibility = View.VISIBLE
        ...
        call.enqueue(object : Callback<V1GetStepSummaryResponse> {
            override fun onResponse(
                ...
                mainView.myLastMonthStepSummaryLoading.visibility = View.GONE
    ...
    private fun setBarChartData(mainResponse: V1GetStepSummaryData) {
        ...
        mainView.barLastMonthChart.description.isEnabled = false

        // if more than 60 entries are displayed in the chart, no values will be
        // drawn
        mainView.barLastMonthChart.setMaxVisibleValueCount(40)

        // scaling can now only be done on x- and y-axis separately
        mainView.barLastMonthChart.setPinchZoom(false)

        mainView.barLastMonthChart.setDrawGridBackground(false)
        mainView.barLastMonthChart.setDrawBarShadow(false)

        mainView.barLastMonthChart.setDrawValueAboveBar(false)
        mainView.barLastMonthChart.isHighlightFullBarEnabled = false

        // change the position of the y-labels
        val leftAxis: YAxis = mainView.barLastMonthChart.axisLeft

        leftAxis.axisMinimum = 0f // this replaces setStartAtZero(true)
        mainView.barLastMonthChart.axisRight.isEnabled = false

        val xLabels: XAxis = mainView.barLastMonthChart.xAxis
...
//        set1.stackLabels = arrayOf("Achieved", "Target")
        ...
        mainView.barLastMonthChart.data = data
        mainView.barLastMonthChart.setFitBars(true)
        mainView.barLastMonthChart.invalidate()


        val l: Legend = mainView.barLastMonthChart.legend
        l.isEnabled = false

        // add a nice and smooth animation
        mainView.barLastMonthChart.animateY(1500)
...
//         chart.setDrawLegend(false);
    ...
    companion object {
         ...
         * @return A new instance of fragment LastMonthStepFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            LastMonthStepFragment().apply {
