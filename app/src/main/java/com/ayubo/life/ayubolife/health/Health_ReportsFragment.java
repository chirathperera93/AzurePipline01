...
public class Health_ReportsFragment extends Fragment {
    ...
    private String mParam1;  private PrefManager pref;
    private String mParam2;
    String url=null;ImageButton  boBack;
    Health_ReportsFragment.OnFragmentInteractionListener mListener;
    //   ProgressDialog prgDialog;
    public Health_ReportsFragment() {
    ...
    public static Health_ReportsFragment newInstance(String param1, String param2) {
        Health_ReportsFragment fragment = new Health_ReportsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_health__reports, container, false);
        ...
        Ram.setIsOne_Medicine(true);
        Ram.setIsTwo_Medicine(false);
      //  health - index.php?module=Documents&action=dynamicHistoryView&filter=allreports

        url =ApiClient.BASE_URL+"index.php?module=Documents&action=dynamicHistoryView&filter=allreports&hash=";

        if (Utility.isInternetAvailable(getContext())) {

            webView = (WebView) view.findViewById(R.id.webView_health_medicalreports);
            webView.getSettings().setJavaScriptEnabled(true);
            webView.getSettings().setLoadsImagesAutomatically(true);
            webView.getSettings().setDomStorageEnabled(true);

            webView.setWebViewClient(new Health_ReportsFragment.Callback());
...
//        }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof Health_ReportsFragment.OnFragmentInteractionListener) {
            mListener = (Health_ReportsFragment.OnFragmentInteractionListener) context;
        } else {
